...
const Nav = () => (
  <nav className='homepage flex my-4 mx-6 justify-between'>
    ...
    <div className='nav-links flex items-end'>
      <ul className='flex space-x-9'>
        <li className='hover:text-teal-400'>Shop</li>
    ...
    <div className='utils flex'>
      ...
      <div className='login flex items-end ml-4 hover:text-teal-400 text-m'>
        <p>Login</p>
      </div>
    </div>
  </nav>
